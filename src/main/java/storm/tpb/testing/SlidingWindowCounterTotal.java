...
import storm.tpb.tools.SlotBasedCounter;
 ...
 * counts of objects, and 2) to give a single "consumer" thread (e.g. {@link }) read access
 ...
 */
public final class SlidingWindowCounterTotal<T> implements Serializable {

  private static final long serialVersionUID = -2645063988768785810L;

  private SlotBasedCounterTotal<T> objCounter;
  private int headSlot;
  private int tailSlot;
  private int windowLengthInSlots;

  public SlidingWindowCounterTotal(int windowLengthInSlots) {
      /*
    ...
    */
    ...
    this.objCounter = new SlotBasedCounterTotal<T>(this.windowLengthInSlots);

    this.headSlot = 0;
    this.tailSlot = slotAfter(headSlot);
  }

  public void incrementCountTotal(Transaction obj) {
    objCounter.incrementCountTotal(obj, headSlot);
  }
   ...
   */
  public Map<Transaction, Long> getCountsThenAdvanceWindow() {
    Map<Transaction, Long> counts = objCounter.getCounts();
