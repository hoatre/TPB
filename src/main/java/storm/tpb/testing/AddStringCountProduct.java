 ...
 */
public class AddStringCountProduct implements CombinerAggregator<List<String>> {
    public AddStringCountProduct() {
    }
    ...
    public List<String> init(TridentTuple tuple) {
        try {
            ...
            jsonObject.put("prd_id", tuple.getStringByField("prd_id"));
